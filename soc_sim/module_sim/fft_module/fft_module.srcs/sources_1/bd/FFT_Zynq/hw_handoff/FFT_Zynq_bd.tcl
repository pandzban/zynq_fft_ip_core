...
################################################################
# This is a generated script based on design: FFT_Zynq
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: fft_butterlfy_ip_0, and set properties
  set fft_butterlfy_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:fft_butterlfy_ip:1.0 fft_butterlfy_ip_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins fft_butterlfy_ip_0/S00_AXIS]
  connect_bd_intf_net -intf_net fft_butterlfy_ip_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins fft_butterlfy_ip_0/M00_AXIS]
