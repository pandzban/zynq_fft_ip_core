...
// Instantiation of Axi Bus Interface M00_AXIS
	...
	fft_butterlfy_ip_v1_0_M00_AXIS # ( 
		.C_M_AXIS_TDATA_WIDTH(C_M00_AXIS_TDATA_WIDTH),
		.C_M_START_COUNT(C_M00_AXIS_START_COUNT)
	) fft_butterlfy_ip_v1_0_M00_AXIS_inst (
	    .Data_Input(Data_Out),
	    .Valid,
...
// Instantiation of Axi Bus Interface S00_AXIS
	...
	fft_butterlfy_ip_v1_0_S00_AXIS # ( 
		.C_S_AXIS_TDATA_WIDTH(C_S00_AXIS_TDATA_WIDTH)
	) fft_butterlfy_ip_v1_0_S00_AXIS_inst (
	    .Data_Out(Data_In),
	    .Write_Done(Done),
	...
	// Add user logic here
	logic [15:0] Data [0:NUMBER_OF_INPUT_WORDS-1];
	
	always @(posedge s00_axis_aclk) begin
	   if(Done) begin
           for(int i = 0;i < NUMBER_OF_INPUT_WORDS;i = i + 1) begin
                Data[i] = Data_In[i][15:0];
           end
       end
	end
