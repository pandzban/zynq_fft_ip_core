...
HD_PWD='C:/Users/Vrael/Desktop/FFT_Project/module_sim/fft_module/fft_module.runs/FFT_Microblaze_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_Microblaze_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_Microblaze_mdm_1_0.tcl
