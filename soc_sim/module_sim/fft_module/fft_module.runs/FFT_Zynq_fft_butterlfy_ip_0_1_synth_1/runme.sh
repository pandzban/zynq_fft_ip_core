...
HD_PWD='C:/Users/Vrael/Desktop/FFT_Project/module_sim/fft_module/fft_module.runs/FFT_Zynq_fft_butterlfy_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_Zynq_fft_butterlfy_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_Zynq_fft_butterlfy_ip_0_1.tcl
