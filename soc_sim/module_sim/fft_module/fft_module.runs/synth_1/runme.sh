...
HD_PWD='D:/addam/Git/SDUP/zynq_fft_ip_core/soc_sim/module_sim/fft_module/fft_module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_Microblaze_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_Microblaze_wrapper.tcl
