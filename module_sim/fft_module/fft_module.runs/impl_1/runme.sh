...
HD_PWD='D:/addam/Git/SDUP/zynq_fft_ip_core/module_sim/fft_module/fft_module.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_Butterfly_Zynq_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FFT_Butterfly_Zynq_wrapper.tcl -notrace
