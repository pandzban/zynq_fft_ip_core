...
HD_PWD='D:/addam/Git/SDUP/zynq_fft_ip_core/module_sim/fft_module/fft_module.runs/Phase_Im_Factor_ROM_Memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Phase_Im_Factor_ROM_Memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Phase_Im_Factor_ROM_Memory.tcl
