...
HD_PWD='C:/Users/Vrael/Desktop/FFT_Project/module_sim/fft_module/fft_module.runs/Phase_Re_Factor_ROM_Memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Phase_Re_Factor_ROM_Memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Phase_Re_Factor_ROM_Memory.tcl
