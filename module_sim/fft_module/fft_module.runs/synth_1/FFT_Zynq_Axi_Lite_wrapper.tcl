...
synth_design -top FFT_Zynq_Axi_Lite_wrapper -part xc7z020clg484-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef FFT_Zynq_Axi_Lite_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file FFT_Zynq_Axi_Lite_wrapper_utilization_synth.rpt -pb FFT_Zynq_Axi_Lite_wrapper_utilization_synth.pb"
