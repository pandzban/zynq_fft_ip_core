...
#
# Generated by export_simulation on Sun Jun 13 16:54:48 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './FFT_Butterfly_Microblaze.sh' script.

./FFT_Butterfly_Microblaze.sh -reset_run
...
./FFT_Butterfly_Microblaze.sh -noclean_files

For more information on the script, please type './FFT_Butterfly_Microblaze.sh -help'.
