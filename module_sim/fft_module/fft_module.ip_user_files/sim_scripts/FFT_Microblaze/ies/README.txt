...
#
# Generated by export_simulation on Sat Jun 12 17:22:20 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './FFT_Microblaze.sh' script.

./FFT_Microblaze.sh -reset_run
...
./FFT_Microblaze.sh -noclean_files

For more information on the script, please type './FFT_Microblaze.sh -help'.
