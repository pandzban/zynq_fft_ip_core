...
#
# Generated by export_simulation on Fri Jun 04 23:38:08 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './FFT_Zynq.sh' script.

./FFT_Zynq.sh -reset_run
...
./FFT_Zynq.sh -noclean_files

For more information on the script, please type './FFT_Zynq.sh -help'.
